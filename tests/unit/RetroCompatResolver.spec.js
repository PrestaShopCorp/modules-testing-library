...
describe('Testing resolver retroCompact', function () {
    it('should call method with class extends', function () {
        ...
        // method not override
        assert.equal(retroCompatResolver.getRequire('youpi.js', overrideMapping), 'youpi.js');
    ...
    it('should not call method with class extends', function () {
        ...
        assert.equal(retroCompatResolver.getRequire('tralala.js', overrideMapping), 'tralala.js');
    });
});
