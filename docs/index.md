...
- [Kernel](./kernel)
  - [Resolvers](./kernel/resolvers)
    * [Version Select Resolver](./kernel/resolvers/versionSelectResolver.md)
  - [Utils](./kernel/utils)
    * [Global parameters](./kernel/utils/globals.md)
    * [Browser Helper](./kernel/utils/helpers.md)
    * [Browser setup with mocha](./kernel/utils/setup.md)
  - [Pages](./pages)
    * [Common page](./pages/commonPage.md)
    * [BO pages](./pages/BO)
      ...
      * [Module manager page](./pages/BO/moduleManager.md)